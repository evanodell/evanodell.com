...
```{r map, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}

golf_ints_summary <- read_rds("golf_ints_summary.rds")
...
```{r top_ten, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r area_passengers, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
