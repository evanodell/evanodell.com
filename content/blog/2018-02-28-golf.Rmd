...
bibliography: [golf-data/golf.bib]
link-citations: true
output:
  blogdown::html_page
...
```{r stations, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r small-stns-circles, message=FALSE, warning=FALSE, include=FALSE, eval=FALSE}
...
```{r summary_and_map, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
golf_ints_summary <- golf_ints_summary %>% 
  ...
  write_rds(golf_ints_summary, "golf_ints_summary.rds")
```


```{r map, echo=FALSE, message=FALSE, warning=FALSE}

golf_ints_summary <- read_rds("golf-data/golf_ints_summary.rds")
...
_This article was republished on [CityMetric](https://www.citymetric.com) on [March 7, 2018](https://www.citymetric.com/fabric/within-2km-station-south-east-england-has-golf-courses-room-500000-homes-3736)_.
