...
author: Evan Odell
date: '2019-04-04'
slug: introducting-uk-police
image: "/img/stop-search.png"
---

The `ukpolice` R package downloads data from the UK Police public data API, the full docs of which are available at https://data.police.uk/docs/. It is now available on [CRAN](https://cran.r-project.org/package=ukpolice), so can be installed with `install.packages("ukpolice")`.
