...
![](/img/lonely-schools/all.tt5.plot2016.png)

#### _Figure 2 - Disadvantaged pupil Attainment 8 score by Index of Isolation_

![](/img/lonely-schools/fsm.tt5.plot2016.png)
...
Figures [1](#figure-1) and [2](#figure-2) above look very similar to the same figures on pages 11 and 13 of [_Lonely Schools_](/files/Lonely-Schools-Odell-2017-AM.pdf).[^2] It is only after controlling for demographics and using CBPS that there are statistically significant differences in the 2016 data.<!-- Stuff on how CBPS isolates the relationship of isolation from other variables -->
...
What does this analysis reveal about the findings of [_Lonely Schools_]({/files/Lonely-Schools-Odell-2017-AM.pdf)? It certainly does not invalidate them, seeing as it only uses a single year of data, and a new method of measuring pupil achievement. What it does show is the importance of having substantial amounts of evidence before making policy. Although there has not been any policy formulated or changed because of the findings of [_Lonely Schools_](/files/Lonely-Schools-Odell-2017-AM.pdf),[^4] making any policy decisions on the basis of a single study would be an incredibly poor decision. Any relationships and correlations identified by a single study should be taken with a grain of salt, and not form the basis of any major policy decision.
