...
output:
  blogdown::html_page
image: "/blog/2018-08-18-benefits-appeals-visuals_files/figure-html/caseload-perc-plot-1.png"
---
...
esa_rate2 <- esa_rate %>%
  filter(hearing_outcome == "Percent In Favour") %>%
  mutate(employment_support_allowance = employment_support_allowance*100)
...
pip_rate2$personal_independence_payment <- as.numeric(pip_rate2$personal_independence_payment)
